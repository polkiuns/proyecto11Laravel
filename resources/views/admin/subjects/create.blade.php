            ...
            <div class="box">
              ...
              <label class="form-control">Agregar una nueva asignatura</label>
                ...
                <div class="form-group {{ $errors->has('courses_id') ? 'has-error' : '' }}">
                  ...
                  {!! Form::select('courses_id[]',$courses, old('courses_id'), ['id' => 'curso','class'=>'form-control' , 'multiple' => true]) !!}
                ...
                <div class="form-group {{ $errors->has('teacher_id') ? 'has-error' : '' }}">
                  ...
                  {!! Form::select('teacher_id[]',$teachers, old('teacher_id'), ['id' => 'teacher_id','class'=>'form-control' , 'multiple' => true]) !!}
