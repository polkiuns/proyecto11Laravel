    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          @auth          
          <li class="nav-item ">
            <a class="nav-link" href="{{route('admin')}}">Mi perfil</a>
          </li>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              @if(auth()->user()->hasRole('student'))
                @foreach(auth()->user()->student->subjects as $subject)
                  @if(isset($subject->name) && isset($subject->courses))
                  <a class="dropdown-item" href="{{route('subjects.index' , array($course = $subject->courses->first() , $subject))}}">{{$subject->name}}</a>
                  @endif
                @endforeach
